...
export default defineComponent(() => {
    ...
    useSeoMeta({
        description: "Připřavovaný článek o použití aplikace Logseq pro správu projektů."
    })

    return () => (
        <>
            <HeaderBar header="Personal Knowledge Management (PKM)" subheader="Článek v přípravě..." />
