...
export default defineComponent({
    setup() {
        const links = [
            { to: '/', title: 'Vizitka' },
            { to: '/clanek/koagulace-a-koagulacni-kaskada/', title: 'Koagulační kaskáda' },
            { to: '/fotografie/', title: 'Fotografie' },
        ...
        return () =>
            <nav class="bg-rose-900">
                <div class="max-w-7xl mx-auto p-4">
                    <div class="flex flex-col tablet:flex-row flex-gaps space-y-1 space-x-0 tablet:space-x-2">
                        {/* Mobile menu button */}
                        <div class="-mr-2 flex tablet:hidden" onClick={smMenuActiveToggle}>
